...
namespace CTeEmissor.Migrations
{
    ...
    [Migration("20250214195413_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CTeEmissor.Dominio.Models.Aliquota", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CTeEmissor.Dominio.Models.CTeNota", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CTeEmissor.Dominio.Models.Carga", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CTeEmissor.Dominio.Models.Compra", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CTeEmissor.Dominio.Models.Viagem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CTeEmissor.Dominio.Models.CTeNota", b =>
                {
                    b.HasOne("CTeEmissor.Dominio.Models.Compra", "Compra")
                        .WithMany()
            ...
            modelBuilder.Entity("CTeEmissor.Dominio.Models.Compra", b =>
                {
                    b.HasOne("CTeEmissor.Dominio.Models.Carga", "Carga")
                        .WithMany()
                        .HasForeignKey("CargaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CTeEmissor.Dominio.Models.Viagem", "Viagem")
                        .WithMany()
            ...
            modelBuilder.Entity("CTeEmissor.Dominio.Models.Viagem", b =>
                {
                    b.HasOne("CTeEmissor.Dominio.Models.Aliquota", "Aliquota")
                        .WithMany()
